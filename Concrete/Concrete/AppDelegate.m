...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[self.mainViewController navigationController] setNavigationBarHidden:NO animated:YES];
    
    self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    self.window.rootViewController = self.mainViewController;
    UIColor *firstColor = [UIColor colorWithRed:84.0f/255.0f green:180.0f/255.0f blue:180.0f/255.0f alpha:1.0f];

    self.window.tintColor = firstColor;
...
-(void) setupParse
{
    ...
    // Initialize Parse.
    [Parse setApplicationId:@"shc41dgrArFJ2Ux5247HS7udcaSQd8fFegyHKLFM"
                  clientKey:@"rV2gxh39Vxsx2gmEwQtddgFnhBGVnUiIVb6on3mG"];
